...
join category as c on d.categoryID=c.categoryID where r.active=1 and finished=0 and checked=0");
$stmt->execute();
        ...
        <div id="page-wrapper">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 align="center">Overzicht van alle reparaties die nog in behandeling zijn</h3>
                </div>
